...
// hreflang values are case-insensitive (ISO 639-1 / ISO 3166-1 Alpha-2); Google's
// own docs use lowercase examples like en-au and de-ch. Only structure matters.
const VALID_HREFLANG = /^x-default$|^[a-z]{2,3}(-[a-z]{2})?$/i;
